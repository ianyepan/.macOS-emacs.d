;;; monochrome-theme.el --- A port of the minimal monochrome theme
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-1-face          ((,class :foreground ,tw-r)))
   `(rainbow-delimiters-depth-2-face          ((,class :foreground ,key2)))
   `(rainbow-delimiters-depth-3-face          ((,class :foreground ,tw-b)))
   `(rainbow-delimiters-depth-4-face          ((,class :foreground ,tw-g)))
   `(rainbow-delimiters-depth-5-face          ((,class :foreground ,tw-r)))
   `(rainbow-delimiters-depth-6-face          ((,class :foreground ,tw-b)))
   `(rainbow-delimiters-depth-7-face          ((,class :foreground ,tw-g)))
